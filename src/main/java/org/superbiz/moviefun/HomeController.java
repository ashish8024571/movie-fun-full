...
public class HomeController {
    ...
    private void createAlbum() {
        TransactionTemplate transactionAlbumTemplate = new TransactionTemplate(albumsPlatformTransactionManager);
        transactionAlbumTemplate.execute(new TransactionCallback() {
            @Override
